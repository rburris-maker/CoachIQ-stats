...
function TimeInput({value, onChange, placeholder, style}){
  ...
  function fmt(raw){
    ...
    if(!d) return "";
    if(d.length<=2) return "0:"+String(Math.min(parseInt(d,10),59)).padStart(2,"0");
    return parseInt(d.slice(0,-2),10)+":"+String(Math.min(parseInt(d.slice(-2),10),59)).padStart(2,"0");
  }
  ...
  return(
    <input value={disp}
      ...
      style={{textAlign:"center",fontFamily:"'Oswald',sans-serif",fontWeight:700,letterSpacing:1,...(style||{})}}
    />
  );
}
